...
impl NanoCell {
    const fn new(val: AppState) -> Self {
        Self(RefCell::new(val))
    }
    #[inline]
    pub fn borrow(&self) -> Ref<'_, AppState> {
        self.0.borrow()
    }
    #[inline]
    pub fn borrow_mut(&self) -> RefMut<'_, AppState> {
        self.0.borrow_mut()
    }
}
...
pub struct AppState {
    ...
    pub quotereg: Option<regex::bytes::Regex>,
    ...
    pub search_regexp: Option<regex::bytes::Regex>,
...
impl AppState {
    ...
    pub fn current_line_data(&self) -> LineData {
        self.openfile
            .as_ref()
    ...
    pub fn remove_magicline_if_empty(&mut self) {
        if let Some(ref mut of) = self.openfile {
            ...
            let should_remove = of
                .filebot
                .as_ref()
                .map(|lb| lb.borrow().data.is_empty() && lb.borrow().prev.is_some())
                .unwrap_or(false);
            if should_remove {
...
pub fn state() -> StateRef {
    STATE.with(|s| {
        ...
        let borrow =
            unsafe { std::mem::transmute::<Ref<'_, AppState>, Ref<'static, AppState>>(borrow) };
        StateRef {
            borrow,
            _owner: owner,
        }
...
mod multibuffer_ring_tests {
    ...
    use crate::definitions::{LineData, LinePtr, LineWeak, OpenFileStruct};
    ...
    fn named_buffer(name: &str) -> (Box<OpenFileStruct>, LineWeak) {
        ...
        line.borrow_mut().data = LineData::from(format!("{name} line"));
...
// From move.c
pub fn do_page_up() {
    crate::move_::do_page_up()
}
pub fn do_page_down() {
    crate::move_::do_page_down()
}
pub fn to_first_line() {
    crate::move_::to_first_line()
}
pub fn to_last_line() {
    crate::move_::to_last_line()
}
pub fn do_up() {
    crate::move_::do_up()
}
...
pub fn to_prev_word() {
    crate::move_::to_prev_word()
}
pub fn to_next_word() {
    crate::move_::to_next_word()
}
pub fn to_prev_block() {
    crate::move_::to_prev_block()
}
pub fn to_next_block() {
    crate::move_::to_next_block()
}
pub fn do_scroll_up() {
    crate::move_::do_scroll_up()
}
pub fn do_scroll_down() {
    crate::move_::do_scroll_down()
}
#[cfg(not(feature = "tiny"))]
pub fn do_scroll_left() {
    crate::move_::do_scroll_left()
}
#[cfg(not(feature = "tiny"))]
pub fn do_scroll_right() {
    crate::move_::do_scroll_right()
}
#[cfg(not(feature = "tiny"))]
pub fn to_top_row() {
    crate::move_::to_top_row()
}
#[cfg(not(feature = "tiny"))]
pub fn to_bottom_row() {
    crate::move_::to_bottom_row()
}
#[cfg(not(feature = "tiny"))]
pub fn do_cycle() {
    crate::move_::do_cycle()
}
...
#[cfg(not(feature = "tiny"))]
pub fn do_center() {
    crate::move_::do_center()
}
#[cfg(feature = "justify")]
pub fn to_para_begin() {
    crate::move_::to_para_begin()
}
#[cfg(feature = "justify")]
pub fn to_para_end() {
    crate::move_::to_para_end()
}
#[cfg(feature = "multibuffer")]
...
pub fn do_search_forward() {
    crate::search::do_search_forward()
}
pub fn do_search_backward() {
    crate::search::do_search_backward()
}
pub fn do_findprevious() {
    crate::search::do_findprevious()
}
pub fn do_findnext() {
    crate::search::do_findnext()
}
pub fn do_replace() {
    crate::search::do_replace()
}
pub fn do_gotolinecolumn() {
    crate::search::do_gotolinecolumn()
}
#[cfg(not(feature = "tiny"))]
pub fn do_find_bracket() {
    crate::search::do_find_bracket()
}
#[cfg(not(feature = "tiny"))]
pub fn put_or_lift_anchor() {
    crate::search::put_or_lift_anchor()
}
#[cfg(not(feature = "tiny"))]
pub fn to_prev_anchor() {
    crate::search::to_prev_anchor()
}
#[cfg(not(feature = "tiny"))]
pub fn to_next_anchor() {
    crate::search::to_next_anchor()
}
...
#[cfg(not(feature = "tiny"))]
pub fn do_indent() {
    crate::text::do_indent()
}
#[cfg(not(feature = "tiny"))]
pub fn do_unindent() {
    crate::text::do_unindent()
}
#[cfg(not(feature = "tiny"))]
pub fn chop_previous_word() {
    crate::cut::chop_previous_word()
}
#[cfg(not(feature = "tiny"))]
pub fn chop_next_word() {
    crate::cut::chop_next_word()
}
#[cfg(not(feature = "tiny"))]
pub fn record_macro() {
    crate::winio::record_macro()
}
#[cfg(not(feature = "tiny"))]
pub fn run_macro() {
    crate::winio::run_macro()
}
#[cfg(not(feature = "tiny"))]
pub fn count_lines_words_and_characters() {
    crate::text::count_lines_words_and_characters()
}
#[cfg(feature = "justify")]
pub fn do_justify() {
    crate::text::do_justify()
}
#[cfg(feature = "justify")]
pub fn do_full_justify() {
    crate::text::do_full_justify()
}
#[cfg(feature = "speller")]
pub fn do_spell() {
    crate::text::do_spell()
...
#[cfg(feature = "linter")]
pub fn do_linter() {
    crate::text::do_linter()
}
#[cfg(feature = "formatter")]
pub fn do_formatter() {
    crate::text::do_formatter()
}
#[cfg(feature = "comment")]
pub fn do_comment() {
    crate::text::do_comment()
}
#[cfg(feature = "wordcomp")]
pub fn complete_a_word() {
    crate::text::complete_a_word()
}

// From files.c
pub fn do_writeout() {
    crate::files::do_writeout()
}
pub fn do_insertfile() {
    crate::files::do_insertfile()
}
pub fn do_savefile() {
    crate::files::do_savefile()
}
#[cfg(not(feature = "tiny"))]
pub fn do_execute() {
    crate::files::do_execute()
}
#[cfg(feature = "browser")]
pub fn to_first_file() {
    crate::browser::to_first_file()
}
#[cfg(feature = "browser")]
pub fn to_last_file() {
    crate::browser::to_last_file()
}
...
pub fn report_cursor_position() {
    crate::winio::report_cursor_position()
}
#[cfg(not(feature = "tiny"))]
pub fn suggest_ctrlT_ctrlZ() {
    crate::nano::suggest_ctrlT_ctrlZ()
}
#[cfg(not(feature = "tiny"))]
pub fn suck_up_input_and_paste_it() {
    crate::nano::suck_up_input_and_paste_it()
}
...
pub fn keycode_from_string(keystring: &str) -> i32 {
    ...
    #[cfg(feature = "nanorc")]
    {
        ...
        if bytes.len() == 6 && bytes[..5].eq_ignore_ascii_case(b"Sh-M-") {
            let ch = bytes[5];
            let lower = ch | 0x20;
...
pub fn first_sc_for(menu: u32, function: FuncPtr) -> Option<(i32, &'static str)> {
    with_state(|s| {
        for sc in &s.sclist {
            if (sc.menus as u32 & menu) != 0 && sc.func == Some(function) && !sc.keystr.is_empty() {
...
pub fn shortcut_init() {
    ...
    let mac_gist = "Toggle the use of Mac format";
    #[cfg(not(feature = "tiny"))]
    ...
    add_to_funcs(do_exit as FuncPtr, MMAIN, "Exit", exit_gist, TOGETHER);
    ...
    let is_restricted =
        with_state(|s| (s.flags[flag_index(RESTRICTED)] & flag_mask(RESTRICTED)) != 0);
    #[cfg(feature = "justify")]
    {
        if !is_restricted {
            add_to_funcs(
                do_insertfile as FuncPtr,
                MMAIN,
                "Read File",
                readfile_gist,
                BLANKAFTER,
    ...
    add_to_funcs(cut_text as FuncPtr, MMAIN, "Cut", cut_gist, TOGETHER);

    add_to_funcs(
        paste_text as FuncPtr,
        MMAIN,
        "Paste",
        paste_gist,
        BLANKAFTER,
    ...
    let is_view_mode = with_state(|s| (s.flags[flag_index(VIEW_MODE)] & flag_mask(VIEW_MODE)) != 0);

    if !is_restricted {
        #[cfg(not(feature = "tiny"))]
        {
            add_to_funcs(
                do_execute as FuncPtr,
                MMAIN,
                "Execute",
                execute_gist,
                TOGETHER,
    ...
    add_to_funcs(
        report_cursor_position as FuncPtr,
        MMAIN,
        "Location",
        cursorpos_gist,
        TOGETHER,
    ...
    #[cfg(not(feature = "tiny"))]
    {
        add_to_funcs(do_undo as FuncPtr, MMAIN, "Undo", undo_gist, TOGETHER);
        add_to_funcs(do_redo as FuncPtr, MMAIN, "Redo", redo_gist, BLANKAFTER);

        add_to_funcs(do_mark as FuncPtr, MMAIN, "Set Mark", mark_gist, TOGETHER);
        add_to_funcs(copy_text as FuncPtr, MMAIN, "Copy", copy_gist, BLANKAFTER);
    }

    add_to_funcs(
        case_sens_void as FuncPtr,
        MWHEREIS | MREPLACE,
        "Case sensitive",
        case_gist,
        TOGETHER,
    ...
    add_to_funcs(do_left as FuncPtr, MMAIN, "Back", back_gist, TOGETHER);
    add_to_funcs(
        do_right as FuncPtr,
        MMAIN,
        "Forward",
    ...
    add_to_funcs(do_home as FuncPtr, MMAIN, "Home", home_gist, TOGETHER);
    add_to_funcs(do_end as FuncPtr, MMAIN, "End", end_gist, TOGETHER);
    #[cfg(not(feature = "tiny"))]
    {
        add_to_funcs(
            do_scroll_left as FuncPtr,
            MMAIN,
            "Scroll Left",
            scrollleft_gist,
            TOGETHER,
    ...
    add_to_funcs(
        to_first_line as FuncPtr,
        MMAIN | MHELP | MGOTOLINE,
        "First Line",
        firstline_gist,
        TOGETHER,
    );
    add_to_funcs(
        to_last_line as FuncPtr,
        MMAIN | MHELP | MGOTOLINE,
        "Last Line",
        lastline_gist,
        BLANKAFTER,
    ...
    {
        add_to_funcs(
            switch_to_prev_buffer as FuncPtr,
            MMAIN,
            "Prev File",
            prevfile_gist,
            TOGETHER,
        ...
        add_to_funcs(
            switch_to_next_buffer as FuncPtr,
            MMAIN,
            "Next File",
            nextfile_gist,
            BLANKAFTER,
    ...
    add_to_funcs(do_tab as FuncPtr, MMAIN, "Tab", tab_gist, TOGETHER);
    add_to_funcs(do_enter as FuncPtr, MMAIN, "Enter", enter_gist, BLANKAFTER);

    add_to_funcs(
        do_backspace as FuncPtr,
        MMAIN,
        "Backspace",
        backspace_gist,
        TOGETHER,
    ...
    {
        add_to_funcs(
            count_lines_words_and_characters as FuncPtr,
            MMAIN,
            "Word Count",
            wordcount_gist,
            TOGETHER,
    ...
    #[cfg(not(feature = "tiny"))]
    {
        add_to_funcs(do_indent as FuncPtr, MMAIN, "Indent", indent_gist, TOGETHER);
        add_to_funcs(
            do_unindent as FuncPtr,
            MMAIN,
            "Unindent",
            unindent_gist,
            BLANKAFTER,
    ...
    #[cfg(not(feature = "tiny"))]
    {
        ...
        add_to_funcs(zap_text as FuncPtr, MMAIN, "Zap", zap_gist, BLANKAFTER);

        add_to_funcs(
            put_or_lift_anchor as FuncPtr,
            MMAIN,
            "Anchor",
            anchor_gist,
            TOGETHER,
        ...
        #[cfg(feature = "linter")]
        {
            add_to_funcs(do_linter as FuncPtr, MMAIN, "Linter", lint_gist, TOGETHER);
        }
        #[cfg(feature = "formatter")]
        {
            add_to_funcs(
                do_formatter as FuncPtr,
                MMAIN,
                "Formatter",
                formatter_gist,
                BLANKAFTER,
    ...
    #[cfg(not(feature = "tiny"))]
    {
        add_to_funcs(do_center as FuncPtr, MMAIN, "Center", center_gist, TOGETHER);
        add_to_funcs(do_cycle as FuncPtr, MMAIN, "Cycle", cycle_gist, BLANKAFTER);
    }

    add_to_funcs(
        do_savefile as FuncPtr,
        MMAIN,
        "Save",
        savefile_gist,
        BLANKAFTER,
    ...
    let modern =
        with_state(|s| (s.flags[flag_index(MODERN_BINDINGS)] & flag_mask(MODERN_BINDINGS)) != 0);
    ...
    if modern {
        ...
        let preserve = with_state(|s| (s.flags[flag_index(PRESERVE)] & flag_mask(PRESERVE)) != 0);
        if !preserve {
            add_to_sclist(MMAIN, "^S", 0, do_savefile as FuncPtr, 0);
        }
        add_to_sclist(MMAIN, "^O", 0, do_writeout as FuncPtr, 0);
        add_to_sclist(MMAIN, "^R", 0, do_insertfile as FuncPtr, 0);
        let preserve2 = with_state(|s| (s.flags[flag_index(PRESERVE)] & flag_mask(PRESERVE)) != 0);
        if !preserve2 {
            add_to_sclist(
                MMAIN | MBROWSER | MHELP,
                "^Q",
    ...
    #[cfg(not(feature = "tiny"))]
    {
        ...
        {
            let preserve3 =
                with_state(|s| (s.flags[flag_index(PRESERVE)] & flag_mask(PRESERVE)) != 0);
            if !preserve3 {
    ...
    #[cfg(not(feature = "tiny"))]
    {
        ...
        add_to_sclist(
            (MMOST | MBROWSER | MHELP | MYESNO) & !MMAIN,
            "^L",
            0,
            full_refresh as FuncPtr,
            0,
    ...
    #[cfg(not(feature = "tiny"))]
    {
        ...
        add_to_sclist(
            (MMOST | MBROWSER | MYESNO) & !MFINDINHELP,
            "M-X",
            0,
            do_toggle as FuncPtr,
            NO_HELP as i32,
        );
    ...
    {
        add_to_sclist(
            MWHEREIS | MREPLACE | MREPLACEWITH | MWHEREISFILE | MFINDINHELP | MEXECUTE,
            "^P",
            0,
            get_older_item as FuncPtr,
            0,
    ...
    add_to_sclist(
        MGOTOLINE | MWHEREIS | MFINDINHELP,
        "^Y",
        0,
        to_first_line as FuncPtr,
        0,
    ...
    let preserve4 = with_state(|s| (s.flags[flag_index(PRESERVE)] & flag_mask(PRESERVE)) != 0);
    if !preserve4 {
    ...
    #[cfg(not(feature = "tiny"))]
    {
        ...
        add_to_sclist(MWRITEFILE, "M-M", 0, mac_format as FuncPtr, 0);
        if !is_restricted && !is_view_mode {
    ...
    #[cfg(not(feature = "tiny"))]
    {
        ...
        add_to_sclist(
            ...
            suck_up_input_and_paste_it as FuncPtr,
            0,
        );
